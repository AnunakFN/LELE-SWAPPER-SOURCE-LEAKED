...
namespace Lele_Swapper.Swapper
{
	public class _14_20 : Form
	{
		...
		private void Image_Click(object sender, EventArgs e)
		{
			...
			JToken val2 = val.get_Item("v2").get_Item((object)"paks").get_Item((object)"entries");
			...
			new CustomPaksTemplate().Show();
			CustomPaksTemplate customPaksTemplate = (CustomPaksTemplate)Application.OpenForms["CustomPaksTemplate"];
			customPaksTemplate.Text = ((object)val2.get_Item((object)int.Parse(s)).get_Item((object)"name")).ToString();
			...
			{
				customPaksTemplate.pictureBox1.Image = Image.FromStream(stream);
			}
			...
			{
				customPaksTemplate.pictureBox3.Image = Image.FromStream(stream2);
			}
			...
			{
				customPaksTemplate.showcase_to.Image = Image.FromStream(stream3);
			}
		...
		private void _14_20_Load(object sender, EventArgs e)
		{
		...
		private void InitializeComponent()
		{
			...
			Text = "_14_20";
			base.Load += new System.EventHandler(_14_20_Load);
			ResumeLayout(false);
		}
	}
}
